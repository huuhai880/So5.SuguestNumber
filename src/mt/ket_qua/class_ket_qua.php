<?php
// File class kết quả của đài. Dùng để chứa dữ liệu đọc được từ web 'https://www.minhngoc.com.vn/ket-qua-xo-so/mien-trung.html'
...
class ket_qua_ngay
{
    ...
    public static function LayKetQuaMienTrung($day_of_week): ket_qua_ngay
    {
        //==============Chuẩn bị dữ liệu===================
        //Lấy toàn bộ dữ liệu từ web xuống
        $url = ket_qua_ngay::layUrlMienTrung($day_of_week);
    ...
    private static function layUrlMienTrung(int $day_of_week): string
    {
        $url_arr = array(
            0 => "https://www.minhngoc.com.vn/ket-qua-xo-so/mien-trung/chu-nhat.html",
            1 => "https://www.minhngoc.com.vn/ket-qua-xo-so/mien-trung/thu-hai.html",
            2 => "https://www.minhngoc.com.vn/ket-qua-xo-so/mien-trung/thu-ba.html",
            3 => "https://www.minhngoc.com.vn/ket-qua-xo-so/mien-trung/thu-tu.html",
            4 => "https://www.minhngoc.com.vn/ket-qua-xo-so/mien-trung/thu-nam.html",
            5 => "https://www.minhngoc.com.vn/ket-qua-xo-so/mien-trung/thu-sau.html",
            6 => "https://www.minhngoc.com.vn/ket-qua-xo-so/mien-trung/thu-bay.html"
        );
        return $url_arr[$day_of_week];
    }
    
    //=====================Lấy ngày xổ Miền Mam =================================
    public static function LayNgayXoMienTrung(): string
    {
        //==============Chuẩn bị dữ liệu===================
        //Lấy toàn bộ dữ liệu từ web xuống
        $url = 'https://www.minhngoc.com.vn/ket-qua-xo-so/mien-trung.html';
        $dom = new DOMDocument();
        libxml_use_internal_errors(true); //Bao cao cac loi neu co
...
class ket_qua_dai
{
    ...
    function HaiConDau(chi_tiet_tin $chi_tiet, float $trung, $so_arr): chi_tiet_tin
    {
        $giai_can_lay =  8;
        $cac_so = $so_arr;
        ...
        foreach ($cac_so as $so) {
            ...
            if(isset($this->cac_giai[$giai_can_lay])){
                ...
                // var_dump($this->cac_giai[$giai_can_lay]);
                // var_dump($so);
                // var_dump(strpos($giai, $so));
    ...
    function HaiConDuoi(chi_tiet_tin $chi_tiet, float $trung, $so_arr): chi_tiet_tin
    {
        $cac_so = $so_arr;
        $size_of_cac_so = sizeof($cac_so);
