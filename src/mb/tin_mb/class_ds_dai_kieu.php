...
class DanhSachDai_MB
{
    public $dais = array();
    function __construct()
    {
        $this->dais = array();
        $this->dais[] = new Ten_MB('Miền Bắc', 'mb', array('hn', 'mb', 'hanoi','HN','Hn','hN'));
    }
...
class DanhSachKieu_MB
{
    ...
    function __construct()
    {
        ...
        $this->kieus[] = new Ten('Xỉu chủ đảo đuôi', 'xdduoi', array(
            "daoxduoi", "daoxiuduoi",
            "daoxcduoi", "daoxchuduoi", 
            "daoxiuchuduoi", "daoxdui",
            "daoxiudui", "daoxcdui",
            "daoxchudui", "daoxiuchdui",
            "daoxchdui", "daoxiuchudui",
            "dxcduoi", "dxcdui",
            "xduidao", "xcduoidao",
            "xcduidao", "xcdaodui",
            "xcdaoduoi", "xdaoduoi",
