...
class tin
{
    ...
    public static function LayTinChuaCoKetQua(string $ten_tai_khoan, string $loai_tai_khoan, $ngay): array
    {
        ...
        $sql = "SELECT * FROM tin WHERE trang_thai = -1 AND tai_khoan_danh = '$ten_tai_khoan' AND vung_mien = 'mb' AND thoi_gian_danh = '$ngay' ";
    ...
    public static function CapNhatKetQuaTin(tin $tin, array $ds_chi_tiet, $ngay_thong_ke, $type): array
    {
        ...
        if($ngay_thong_ke){
            ...
            $check_time = strtotime(date('Y-m-d') . '18:30:00');
            $ngay_danh_of_tin = strtotime($ngay_thong_ke . '18:30:00');
    ...
    public static function DaCoKetQua(tin $tin): bool
    {
        ...
        $current_time = time();
        $check_time = strtotime(date('Y-m-d') . '18:35:00');
